...
antsApplyTransforms \
  -i $DERIV/sWM/sub-${SUB}_ses-${SES}/sub-${SUB}_ses-${SES}/_space-fsnative_aparc+aseg.nii.gz \
  -r $DERIV/micapipe_v0.2.0/sub-${SUB}/ses-${SES}/anat/sub-${SUB}_ses-${SES}_space-nativepro_T1w.nii.gz \
  -o $DERIV/sWM/sub-${SUB}_ses-${SES}/sub-${SUB}_ses-${SES}/_space-nativepro_aparc+aseg.nii.gz \
  -n MultiLabel
#  -t $tform
...
python sWM/laplace_solver.py \
  $DERIV/sWM/sub-${SUB}_ses-${SES}/sub-${SUB}_ses-${SES}/_space-nativepro_aparc+aseg.nii.gz \
  $DERIV/sWM/sub-${SUB}_ses-${SES}/sub-${SUB}_ses-${SES}/_space-nativepro_laplace-wm.nii.gz 
python sWM/surface_generator.py \
  ...
  $DERIV/sWM/sub-${SUB}_ses-${SES}/sub-${SUB}_ses-${SES}/_space-nativepro_laplace-wm.nii.gz \
  $DERIV/sWM/sub-${SUB}_ses-${SES}/sub-${SUB}_ses-${SES}/_space-nativepro_label-sWF_depth- 
